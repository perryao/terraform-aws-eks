...
variable "workers_group_defaults" {
  ...
  default = {
    ...
    kubelet_taints       = ""            # This string is passed directly to kubelet via --register-with-taints= if set. It should be comma delimited with no spaces. If left empty no register-with-taints switch is added
